...
def initiate():
    car_make_data = [
        {"name":"NISSAN", "description":"Great cars. Japanese technology", "year":"2023"},
        {"name":"Mercedes", "description":"Great cars. German technology", "year":"2023"},
        {"name":"Audi", "description":"Great cars. German technology", "year":"2023"},
        {"name":"Kia", "description":"Great cars. Korean technology", "year":"2023"},
        {"name":"Toyota", "description":"Great cars. Japanese technology", "year":"2023"},
    ]

    car_make_instances = []
    for data in car_make_data:
            car_make_instances.append(CarMake.objects.create(name=data['name'], description=data['description'], year_made=data['year']))
